...
resolution.addEventListener('click', ()=>{
      ...
      if (W<D){
         document.getElementById('message').innerHTML="¡¡¡La tasa de producción es menor a la Demanda!!! \n Vuelva a ingresar los datos..";
            ...
            let Q=document.getElementById("Q_value").value;
            let N=document.getElementById("N_value").value;
            let t=document.getElementById('t_value').value;
            let Im=document.getElementById('Im_value').value;
            let ti=document.getElementById('ti_value').value;
